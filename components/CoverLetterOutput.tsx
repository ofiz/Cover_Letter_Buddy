...
import { FileText, Download, Edit3, Copy, RotateCcw, Save } from 'lucide-react'
    ...
    <div className="w-full space-y-6">
      ...
      >
        {isEditing ? (
          ...
          <div className="text-white leading-relaxed whitespace-pre-wrap font-mono text-sm">
            {editedContent || 'Your cover letter will appear here...'}
          </div>
        )}
      </div>
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 
                   disabled:bg-indigo-800 disabled:cursor-not-allowed text-white rounded-lg 
                   transition-all duration-200"
        >
